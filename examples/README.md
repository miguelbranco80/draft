...
| [`tetris`](tetris/) | A full-screen terminal game with raw timed input, fragmented arrow-key decoding, portable resize watching, Unicode-capable `core/tui` cell painting and differential output, seven-bag pieces, collision and wall kicks, scoring, levels, clean restoration, and deterministic tests. |
