...
Status: `0.1.0-alpha.4` distribution contract.
...
- `draft-0.1.0-alpha.4-aarch64-macos.tar.xz`
- `draft-0.1.0-alpha.4-aarch64-linux.tar.xz`
- `draft-0.1.0-alpha.4-x86_64-linux.tar.xz`
- `draft-0.1.0-alpha.4-x86_64-windows.zip`
...
Pushing a tag such as `v0.1.0-alpha.4` starts the separate release workflow.
