...
// obligation includes grammar category, expected-type identity, visible binding
// names/types, target-covered input digest, and stable site identity. prompt and
...
struct SynthesisRequest {
  std::string format = "draft-synthesis-request-v1";
