...
// documentation, canonical enclosing declaration, active denial selectors,
// parametric constraints, positionally available judgment claims, persistent source coordinates, the exact input
...
struct SynthesisRequest {
  std::string format = "draft-synthesis-request-v7";
