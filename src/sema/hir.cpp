// Append-only storage for procedure-owned typed Draft HIR.
//
...
// produces one such arena per exact procedure product. Semantic IDs and source
// coordinates are not owned here. No operation in this module combines arenas
// or rewrites their local IDs.
//
// This module depends only on the HIR representation and base C++ facilities.
// It performs no checking, target classification, or lowering.
