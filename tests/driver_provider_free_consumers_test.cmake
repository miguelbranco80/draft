...
run_provider_free(resolve_stdout
  resolve "${workspace}/app" --revalidate --target "${TARGET_SELECTOR}")
...
run_provider_free(check_stdout
  check "${workspace}/app" --target "${TARGET_SELECTOR}")
...
run_provider_free(build_stdout
  build "${workspace}/app" --target "${TARGET_SELECTOR}"
...
run_provider_free(test_stdout
  test "${workspace}/app" --target "${TARGET_SELECTOR}")
...
run_provider_free(bench_stdout
  bench "${workspace}/app" --target "${TARGET_SELECTOR}")
