...
judgment history, including exact-key failure revocation. Provider execution,
manifest selection, and locked judgment-evidence verification remain to be
wired before the command boundary is complete.
