...
| Content-addressed generated source and atomic manifest commit | v3 resolution manifests, resolution/store/overlay modules, interrupted-publish recovery, and a typed native precommit Test gate | Implemented foundation | Add exact persisted validation/judgment evidence references to the manifest schema. |
